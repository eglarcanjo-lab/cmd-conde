...
const ST = {
  ...
  btnUpload: { background: "rgba(99,102,241,0.14)", border: "1px solid rgba(99,102,241,0.4)", color: "#a5b4fc", padding: "10px 16px", borderRadius: "8px", cursor: "pointer", fontSize: "0.82rem", fontFamily: "inherit", fontWeight: "600" },
