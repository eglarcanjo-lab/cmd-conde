...
const styles = {
  ...
  inputMes: { background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px", color: "#fff", padding: "6px 10px", fontSize: "0.85rem", fontFamily: "inherit", outline: "none" },
  ...
  content: { padding: "24px 32px", maxWidth: "900px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "20px" },
  ...
  totalCard: { background: "linear-gradient(135deg, rgba(251,185,0,0.08), rgba(251,185,0,0.03))", border: "1px solid rgba(251,185,0,0.2)", borderRadius: "14px", padding: "20px 28px", display: "flex", justifyContent: "space-between", alignItems: "center" },
