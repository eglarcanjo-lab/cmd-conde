      ...
      {loading ? (
        ...
        <div style={S.grid}>
          {lista.map((inc) => (
            <div
              key={inc.id}
              style={{ ...S.card, borderColor: (inc.cor || "#fbb900") + "55" }}
              onClick={() => abrir(inc)}
            >
              <div style={{ ...S.cardBar, background: inc.cor || "#fbb900" }} />
      ...
      {sel && (
        <div style={S.overlay} onClick={() => setSel(null)}>
          <div style={S.modal} onClick={(e) => e.stopPropagation()}>
            <div style={{ ...S.modalHeader, borderColor: (sel.cor || "#fbb900") }}>
              <div>
              ...
              <>
                {ranking?.minha_posicao && (
                  <div style={S.minhaPos}>
                    ...
                    <strong style={{ color: sel.cor || "#fbb900", fontSize: "1.3rem" }}>
                    ...
                    ranking.ranking.map((r) => {
                      ...
                      return (
                        <div key={r.setor} style={{ ...S.rankRow, ...(eu ? S.rankRowEu : {}) }}>
                          <span style={{ ...S.rankPos, color: r.posicao <= 3 ? "#fbb900" : "rgba(255,255,255,0.4)" }}>
                            {medalha(r.posicao)}
                          </span>
...
const S = {
  root:        { minHeight: "100vh", background: "#0a0f1e", fontFamily: "'Segoe UI', system-ui, sans-serif", padding: "clamp(16px,4vw,28px)", maxWidth: "760px", margin: "0 auto", color: "#fff" },
  ...
  premioChip:  { background: "rgba(251,185,0,0.14)", color: "#fbb900", padding: "2px 10px", borderRadius: "20px", fontSize: "0.74rem", fontWeight: "600" },
  ...
  modal:       { background: "#0f1424", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "16px", width: "100%", maxWidth: "480px", maxHeight: "88vh", overflowY: "auto", padding: "20px" },
  modalHeader: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "12px", borderBottom: "2px solid #fbb900", paddingBottom: "12px", marginBottom: "12px" },
  modalTitle:  { color: "#fff", fontWeight: "700", fontSize: "1.1rem" },
  modalPremio: { color: "#fbb900", fontSize: "0.85rem", marginTop: "4px", fontWeight: "600" },
  ...
  minhaPos:    { display: "flex", alignItems: "center", gap: "12px", background: "rgba(251,185,0,0.1)", border: "1px solid rgba(251,185,0,0.3)", borderRadius: "10px", padding: "10px 14px", marginBottom: "14px", fontSize: "0.85rem", color: "rgba(255,255,255,0.7)" },
  ...
  rankRowEu:   { background: "rgba(251,185,0,0.1)", border: "1px solid rgba(251,185,0,0.35)" },
  ...
  euTag:       { background: "#fbb900", color: "#0a0f1e", fontSize: "0.62rem", fontWeight: "700", padding: "1px 6px", borderRadius: "10px", marginLeft: "6px", verticalAlign: "middle" },
  rankSetor:   { color: "rgba(255,255,255,0.35)", fontSize: "0.7rem" },
  rankValor:   { color: "#fbb900", fontWeight: "700", fontSize: "0.9rem", flexShrink: 0 },
};

const CSS = `
.inc-spinner { width: 32px; height: 32px; border: 3px solid rgba(251,185,0,0.15); border-top-color: #fbb900; border-radius: 50%; animation: inc-spin 0.8s linear infinite; }
