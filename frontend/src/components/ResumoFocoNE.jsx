...
const S = {
  ...
  sec: { color: "#7DBA3D", fontSize: "0.78rem", letterSpacing: "0.4px", margin: "0 2px 8px", display: "flex", alignItems: "center", gap: "6px" },
  escopo: { marginLeft: "auto", color: "rgba(255,255,255,0.4)", fontSize: "0.68rem", fontWeight: "400", letterSpacing: 0 },
  grid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: "9px" },
  mini: { background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "12px", padding: "10px 11px" },
  miniTop: { display: "flex", alignItems: "center", gap: "6px" },
  lbl: { color: "rgba(255,255,255,0.6)", fontSize: "0.74rem" },
  tag: { marginLeft: "auto", color: "rgba(255,255,255,0.35)", fontSize: "0.62rem", background: "rgba(255,255,255,0.06)", borderRadius: "20px", padding: "1px 7px" },
  val: { color: "#fff", fontSize: "1.05rem", fontWeight: "600", margin: "5px 0 0", display: "flex", alignItems: "baseline" },
  meta: { color: "rgba(255,255,255,0.4)", fontSize: "0.72rem", fontWeight: "400", marginLeft: "4px" },
  pc: { marginLeft: "auto", fontSize: "0.82rem", fontWeight: "600" },
  bar: { height: "5px", background: "rgba(255,255,255,0.06)", borderRadius: "3px", marginTop: "7px", overflow: "hidden" },
  fill: { height: "100%", borderRadius: "3px", transition: "width 0.4s" },
  skel: { color: "rgba(255,255,255,0.35)", fontSize: "0.78rem", padding: "4px 2px" },
};
