...
- **Robô** (local): novo farol `volumes` (FAROIS + MOTOR.bat opções 7/8, sem pergunta de dia). Coloração por célula via `_cores` (verde ≥100% · âmbar 70–99% · vermelho <70%), colunas `rn`/`categoria` alinhadas à esquerda.
