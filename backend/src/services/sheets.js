...
async function initializeSheets() {
  const tabs = {
    ...
    entregas_efetivadas: ["setor","volume_entregue_hl","linhas","mes_referencia"],
    ruptura_mes: ["setor","cod_produto","nome_produto","categoria","qtd_faltas","volume_falta_hl","mes_referencia"],
    ruptura_quadrimestre: ["cod_produto","nome_produto","mes","qtd_faltas","volume_falta_hl"],
