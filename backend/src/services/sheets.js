...
async function initializeSheets() {
  const tabs = {
    ...
    ruptura_produto: ["cod_produto","nome_produto","categoria","mes","qtd_faltas","volume_falta_hl"],
    ruptura_cliente: ["setor","cod_pdv","nome_pdv","mes","qtd_faltas","volume_falta_hl"],
